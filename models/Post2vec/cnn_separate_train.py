...
from utils.file_util import write_str2file
from utils.pkl_util import load_pickle
from utils.time_util import get_current_time, Timer
...
if args.model_selection == 'separate_all_cnn':
    from model_all_separate_cnn import MultiComp, train

    model = MultiComp(args=args)
elif args.model_selection == 'separate_title_desctext_cnn':
    from model_title_desctext_separate_cnn import MultiComp, train
