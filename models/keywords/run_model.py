...
data_arg.add_argument('--only_title', type=str2bool, default=True)
data_arg.add_argument('--embed_path', type=str, default="glove/glove.6B.200d.txt")
...
model_arg.add_argument('--top_keyword', type=int, default=10)
...
def main(config):
    ...
    model.run(valid_feed, non_valid_feed ,label_dict, vocab)
